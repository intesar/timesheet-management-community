...
<h:outputText value="Priority:"/>
 <h:inputText id="priority" value="#{task.task.priority}" title="Priority" />
...
<h:outputText value="PriorityTypes:" rendered="#{task.task.priorityTypes == null}"/>
 <h:selectOneMenu id="priorityTypes" value="#{task.task.priorityTypes}" title="PriorityTypes" rendered="#{task.task.priorityTypes == null}">
 <f:selectItems value="#{task.priorityTypess}"/>
 </h:selectOneMenu>
</h:panelGrid>
<br />
<h:commandLink action="#{task.createFromProject}" value="Create" rendered="#{task.task.project != null and task.task.percentageCompleted == null and task.task.status == null and task.task.priorityTypes == null}"/>
<h:commandLink action="#{task.createFromPercentageValues}" value="Create" rendered="#{task.task.percentageCompleted != null and task.task.project == null and task.task.status == null and task.task.priorityTypes == null}"/>
<h:commandLink action="#{task.createFromStatusCodes}" value="Create" rendered="#{task.task.status != null and task.task.project == null and task.task.percentageCompleted == null and task.task.priorityTypes == null}"/>
<h:commandLink action="#{task.createFromPriorityTypes}" value="Create" rendered="#{task.task.priorityTypes != null and task.task.project == null and task.task.percentageCompleted == null and task.task.status == null}"/>
<h:commandLink action="#{task.create}" value="Create" rendered="#{task.task.project == null and task.task.percentageCompleted == null and task.task.status == null and task.task.priorityTypes == null}"/>
<br />
