...
public class PaymentTypesController {
    ...
    public String createFromPaymentSetup() {
        this.paymentTypes = new cm.PaymentTypes();
        EntityManager em = getEntityManager();
        try {
    ...
    public String edit() {
        ...
        try {
            utx.begin();
            Collection<Payment> paymentsOld = em.find(cm.PaymentTypes.class, paymentTypes.getId()).getPaymentCollection();
            paymentTypes = em.merge(paymentTypes);
    ...
    public String destroy() {
        ...
        try {
            utx.begin();
            cm.PaymentTypes paymentTypes = getPaymentTypesFromRequestParam();
            paymentTypes = em.merge(paymentTypes);
    ...
    public PaymentTypes getPaymentTypesFromRequestParam() {
        EntityManager em = getEntityManager();
        try {
            cm.PaymentTypes o = (cm.PaymentTypes) model.getRowData();
            o = em.merge(o);
            return o;
        } finally {
            em.close();
    ...
    public PaymentTypes findPaymentTypes(Integer id) {
        EntityManager em = getEntityManager();
        try {
            cm.PaymentTypes o = (cm.PaymentTypes) em.find(cm.PaymentTypes.class, id);
            return o;
        } finally {
            em.close();
        }
