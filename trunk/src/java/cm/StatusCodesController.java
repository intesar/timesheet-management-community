...
public class StatusCodesController {
    ...
    public String createFromProjectSetup() {
        this.statusCodes = new cm.StatusCodes();
        EntityManager em = getEntityManager();
        try {
    ...
    public String edit() {
        ...
        try {
            utx.begin();
            Collection<Project> projectsOld = em.find(cm.StatusCodes.class, statusCodes.getId()).getProjectCollection();
            Collection<Task> tasksOld = em.find(cm.StatusCodes.class, statusCodes.getId()).getTaskCollection();
            statusCodes = em.merge(statusCodes);
    ...
    public String destroy() {
        ...
        try {
            utx.begin();
            cm.StatusCodes statusCodes = getStatusCodesFromRequestParam();
            statusCodes = em.merge(statusCodes);
    ...
    public StatusCodes getStatusCodesFromRequestParam() {
        EntityManager em = getEntityManager();
        try {
            cm.StatusCodes o = (cm.StatusCodes) model.getRowData();
            o = em.merge(o);
            return o;
        } finally {
            em.close();
    ...
    public StatusCodes findStatusCodes(Integer id) {
        EntityManager em = getEntityManager();
        try {
            cm.StatusCodes o = (cm.StatusCodes) em.find(cm.StatusCodes.class, id);
            return o;
        } finally {
            em.close();
        }
