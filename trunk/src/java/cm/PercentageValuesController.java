...
public class PercentageValuesController {
    ...
    public String createFromTaskSetup() {
        this.percentageValues = new cm.PercentageValues();
        EntityManager em = getEntityManager();
        try {
    ...
    public String edit() {
        ...
        try {
            utx.begin();
            Collection<Task> tasksOld = em.find(cm.PercentageValues.class, percentageValues.getId()).getTaskCollection();
            Collection<Payment> paymentsOld = em.find(cm.PercentageValues.class, percentageValues.getId()).getPaymentCollection();
            percentageValues = em.merge(percentageValues);
    ...
    public String destroy() {
        ...
        try {
            utx.begin();
            cm.PercentageValues percentageValues = getPercentageValuesFromRequestParam();
            percentageValues = em.merge(percentageValues);
    ...
    public PercentageValues getPercentageValuesFromRequestParam() {
        EntityManager em = getEntityManager();
        try {
            cm.PercentageValues o = (cm.PercentageValues) model.getRowData();
            o = em.merge(o);
            return o;
        } finally {
            em.close();
    ...
    public PercentageValues findPercentageValues(Integer id) {
        EntityManager em = getEntityManager();
        try {
            cm.PercentageValues o = (cm.PercentageValues) em.find(cm.PercentageValues.class, id);
            return o;
        } finally {
            em.close();
        }
