...
public class TaskController {
    ...
    public String createFromPercentageValuesSetup() {
        ...
        EntityManager em = getEntityManager();
        try {
            task.setPercentageCompleted(em.find(PercentageValues.class, getPercentageValuesController().getPercentageValues().getId()));
        } finally {
            em.close();
        }
        return "task_create";
    ...
    public String createFromStatusCodesSetup() {
        ...
        EntityManager em = getEntityManager();
        try {
            task.setStatus(em.find(StatusCodes.class, getStatusCodesController().getStatusCodes().getId()));
        } finally {
            em.close();
        }
        return "task_create";
    ...
    public String destroyFromPriorityTypes() {
        ...
        EntityManager em = getEntityManager();
        try {
            getPriorityTypesController().setPriorityTypes(em.find(PriorityTypes.class, param.getId()));
        } finally {
            em.close();
        }
    ...
    public String createFromPriorityTypesSetup() {
        ...
        EntityManager em = getEntityManager();
        try {
            task.setPriorityTypes(em.find(PriorityTypes.class, getPriorityTypesController().getPriorityTypes().getId()));
        } finally {
            em.close();
        }
        return "task_create";
    ...
    public String createFromPriorityTypes() {
        create();
        getPriorityTypesController().setPriorityTypes(task.getPriorityTypes());
        return "priorityTypes_detail";
    }
    ...
    public String create() {
        ...
        try {
            ...
            PriorityTypes priorityTypes = task.getPriorityTypes();
            if (priorityTypes != null) {
                priorityTypes = em.merge(priorityTypes);
                priorityTypes.setTask(task);
                priorityTypes = em.merge(priorityTypes);
            }
    ...
    public String edit() {
        ...
        try {
            utx.begin();
            Project projectOld = em.find(cm.Task.class, task.getId()).getProject();
            PercentageValues percentageCompletedOld = em.find(cm.Task.class, task.getId()).getPercentageCompleted();
            StatusCodes statusOld = em.find(cm.Task.class, task.getId()).getStatus();
            PriorityTypes priorityTypesOld = em.find(cm.Task.class, task.getId()).getPriorityTypes();
            Collection<Payment> paymentsOld = em.find(cm.Task.class, task.getId()).getPaymentCollection();
            task = em.merge(task);
            ...
            PriorityTypes priorityTypesNew = task.getPriorityTypes();
            if (priorityTypesNew != null) {
                priorityTypesNew.setTask(task);
                priorityTypesNew = em.merge(priorityTypesNew);
            }
            if (priorityTypesOld != null) {
                priorityTypesOld.setTask(null);
                priorityTypesOld = em.merge(priorityTypesOld);
            }
    ...
    public String destroy() {
        ...
        try {
            utx.begin();
            cm.Task task = getTaskFromRequestParam();
            task = em.merge(task);
            Project project = task.getProject();
            if (project != null) {
                project = em.merge(project);
    ...
    public Task getTaskFromRequestParam() {
        EntityManager em = getEntityManager();
        try {
            cm.Task o = (cm.Task) model.getRowData();
            o = em.merge(o);
            return o;
        } finally {
            em.close();
    ...
    public Task findTask(Integer id) {
        EntityManager em = getEntityManager();
        try {
            cm.Task o = (cm.Task) em.find(cm.Task.class, id);
            return o;
        } finally {
            em.close();
        }
    ...
    public SelectItem[] getPriorityTypess() {
        EntityManager em = getEntityManager();
        try {
