 ...
 *
 * @see com.abbhsoft.faq.model.Questions
...
public class QuestionsDAO extends BaseHibernateDAO {
    ...
    public List findByExample(Questions instance) {
        ...
        try {
            List results = getSession().createCriteria("com.abbhsoft.faq.model.Questions").add(Example.create(instance)).list();
    ...
    public List findByProperty(String propertyName, Object value) {
        log.debug("finding Questions instance with property: " + propertyName + ", value: " + value);
        try {
    ...
    public List findByQuestion(String key) {
        log.debug("finding all Questions instances");
        try {
            String queryString = "select a from Questions a where a.question like '%" +key+"%'";
            Query queryObject = getSession().createQuery(queryString);
            return queryObject.list();
        } catch (RuntimeException re) {
             re.printStackTrace();
            log.error("findByQuestion failed", re);
            throw re;
        }
    }
