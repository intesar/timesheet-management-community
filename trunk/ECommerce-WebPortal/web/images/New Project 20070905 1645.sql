...
--
-- Create schema e_commerce_test
--

CREATE DATABASE IF NOT EXISTS e_commerce_test;
USE e_commerce_test;
...
INSERT INTO `item` (`id`,`name`,`description`,`ingredients`,`price`,`tax`,`is_enabled`,`img_url`,`quantity_available`) VALUES 
 (1,'chicken curry','chicken cooked in curd and spices',NULL,4.99,0.789,1,'biryani.jpg',1);
