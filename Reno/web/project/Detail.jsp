...
<br />
<b>List of BusinessCompanyCollection:</b>
<h:outputText rendered="#{businessCompany.detailBusinessCompanys.rowCount == 0}" escape="false" value="<br />(No BusinessCompanyCollection Found)"/>
<br />
<h:dataTable value="#{businessCompany.detailBusinessCompanys}" var="item" 
border="1" cellpadding="2" cellspacing="0" 
 rendered="#{businessCompany.detailBusinessCompanys.rowCount > 0}">
<h:column>
 <f:facet name="header">
 <h:outputText value="Id"/>
 </f:facet>
...
<h:column>
 ...
 <h:column>
 <h:commandLink value="Destroy" action="#{businessCompany.destroyFromProject}">
...
<h:commandLink value="Remove" action="#{project.removeBusinessCompanyCollection}"/></h:column>
</h:dataTable>
<h:panelGroup rendered="#{not empty project.businessCompanyCollectionAvailable}"><br />
<b>Add BusinessCompanys:</b>
<br />
<h:selectManyListbox id="addBusinessCompanys" value="#{project.businessCompanyCollectionToAdd}" title="Add BusinessCompanyCollection:">
<f:selectItems value="#{project.businessCompanyCollectionAvailable}"/>
</h:selectManyListbox>
<h:commandButton value="Add" action="#{project.addBusinessCompanyCollection}"/>
 <br>
</h:panelGroup>
<br />
<h:commandLink value="Add New BusinessCompany" action="#{businessCompany.createFromProjectSetup}">
<f:param name="relatedId" value="#{project.project.id}"/>
</h:commandLink>
<br />
<br />
